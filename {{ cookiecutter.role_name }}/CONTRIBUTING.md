...
- Check out the [existing issues](https://github.com/racqspace/ansible-role-{{ cookiecutter.role_name }}/issues) & see if we [accept contributions](#types-of-contributions-memo) for your type of issue.
- Before you make your changes, check to see if an [issue exists](https://github.com/racqspace/ansible-role-{{ cookiecutter.role_name }}/issues/) already for the change you want to make.
...
Once your PR is merged, you will be proudly listed as a contributor in the [contributor chart](https://github.com/racqspace/ansible-role-{{ cookiecutter.role_name }}/graphs/contributors).
...
You can contribute in several ways. This repo is a place to discuss and collaborate on the ansible role racqspace.{{ cookiecutter.role_name }}! Our small, but mighty :muscle: racqspace team is maintaining this repo. To preserve our bandwidth, off topic conversations will be closed.

### :mega: Discussions
Discussions are where we have conversations.

If you'd like help troubleshooting a PR you're working on, have a great new idea, or want to share something amazing you've learned in our docs, join us in [discussions](https://github.com/racqspace/ansible-role-{{ cookiecutter.role_name }}/discussions).
